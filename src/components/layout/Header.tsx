...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-b border-slate-200 dark:border-slate-700">
      <div className="flex h-full items-center justify-between px-4 lg:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/" className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-docker-blue">
              <svg
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-4">
          ...
          >
            ...
            <span>検索...</span>
            <kbd className="absolute right-3 top-1/2 -translate-y-1/2 hidden sm:inline-flex items-center gap-1 px-2 py-0.5 text-xs bg-slate-200 dark:bg-slate-700 rounded">
              Ctrl+K
            </kbd>
          </button>
        </div>
