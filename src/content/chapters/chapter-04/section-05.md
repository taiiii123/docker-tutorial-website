...
![サービスの起動順序](/images/diagrams/compose-startup-order.png)
...
![depends_on未使用時の起動タイミング](/images/diagrams/startup-timing-no-depends.png)
...
![healthcheck使用時の起動タイミング](/images/diagrams/startup-timing-healthcheck.png)
...
![複数サービスの起動シーケンス](/images/diagrams/multi-service-startup-sequence.png)
