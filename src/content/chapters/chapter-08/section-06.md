...
![Docker Swarmクラスター構成](/images/diagrams/swarm-cluster.png)
...
![サービスとタスクの関係](/images/diagrams/swarm-service-task.png)
...
![Swarm Ingressネットワーク](/images/diagrams/swarm-ingress.png)
