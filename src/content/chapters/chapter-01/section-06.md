...
│Containers│                                              │
│        │  ┌──────────────────────────────────────────┐ │
│ 🖼️     │  │ NAME        IMAGE    STATUS    ACTIONS   │ │
│Images  │  ├──────────────────────────────────────────┤ │
│        │  │ webserver   nginx    Running   ▶️ 🗑️     │ │
│ 💾     │  │ db          mysql    Running   ▶️ 🗑️     │ │
│Volumes │  │ redis       redis    Stopped   ▶️ 🗑️     │ │
│        │  └──────────────────────────────────────────┘ │
│ 🌐     │                                                │
│Networks│                                                │
│        │                                                │
...
├─────────────────────────────────────────────────────────┤
│                                                         │
│  2024/01/15 10:30:00 [notice] 1#1: start worker process │
│  2024/01/15 10:30:05 172.17.0.1 - - GET / HTTP/1.1 200  │
│  2024/01/15 10:30:10 172.17.0.1 - - GET / HTTP/1.1 200  │
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
├─────────────────────────────────────────────────────────┤
│  nginx         latest   187 MB    2 days ago   Yes      │
│  mysql         8.0      577 MB    1 week ago   Yes      │
│  node          20       1.1 GB    1 week ago   No       │
│  hello-world   latest   13.3 KB   3 months     No       │
└─────────────────────────────────────────────────────────┘
```
